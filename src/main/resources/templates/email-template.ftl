					...
					<tr>
						<td align="center" valign="top" bgcolor="grey"
							...
							<div style="font-size: 20px; color: green;">
								<br> Congratulations ${customer.getName()}
							</div>
							
							<div style="font-size: 24px; color: pink;">
								<br> Your Request for Registration as Customer Has Been Received 
							</div>
							<div>
								...
								<div>
								<a href="http://localhost:8080/customers/confirm?token=${customer.getToken()}">click here</a>
								</div> <br>
								<div>
